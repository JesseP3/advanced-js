...
console.log(reductEvens(10));
console.log(reductEvens(11));
...
console.log(shortenString("Jesse"));
console.log(shortenString("JesseJesse"));
...
const mealPrice = burrito + nacho + soda;
...
const factorialCalculations = (numForFactorial) =>{
    if(numForFactorial == 1){
        console.log("number typed must be bigger than one because factorial of one is one.");
    }else{
        let base = 1;
